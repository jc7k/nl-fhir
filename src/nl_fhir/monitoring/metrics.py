...
# Application Info
app_info = Info('nl_fhir_app', 'NL-FHIR Application Information')
app_info.info({
    'version': '1.0.0',
    'name': 'nl-fhir',
...
system_cpu_usage_percent = Gauge(
    'nl_fhir_system_cpu_usage_percent',
    'System CPU usage percentage'
)

system_memory_usage_bytes = Gauge(
    'nl_fhir_system_memory_usage_bytes',
    'System memory usage in bytes'
)

system_memory_available_bytes = Gauge(
    'nl_fhir_system_memory_available_bytes',
...
cache_hits_total = Counter(
    'nl_fhir_cache_hits_total',
    'Total cache hits',
    ['cache_type']
)

cache_misses_total = Counter(
    'nl_fhir_cache_misses_total',
    'Total cache misses',
    ['cache_type']
)
...
class MetricsCollector:
    ...
    @staticmethod
    def record_conversion(success: bool, duration: float, resource_types: Optional[list] = None):
    ...
    @staticmethod
    def record_nlp_extraction(entity_type: str, duration: Optional[float] = None):
